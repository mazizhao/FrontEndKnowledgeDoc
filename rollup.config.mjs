...
export default {
    ...
    plugins: [
        ...
        ts({
            // tsconfig: path.resolve(__dirname, 'tsconfig.json') // 如果使用的.mjs是不支持这种格式
            // tsconfig: 'tsconfig.json' // 配置文件不能采用__dirname 解析路径，因为mjs中没有__dirname
